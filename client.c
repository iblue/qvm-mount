/*
  QVM file system
  Original SSHFS implementation by:
  Copyright (C) 2004  Miklos Szeredi <miklos@szeredi.hu>

  Modifications by:
  Copyright (C) 2021  Markus Fenske <iblue@gmx.net>

  This program can be distributed under the terms of the GNU GPL.
  See the file LICENSE.

  This is basically sshfs without the ssh, but instead pushes data out through 
  pipes.
*/
